    ...
    <div class="contenedor__todo">
        <div class="caja__trasera">
            <div class="caja_trasera-login">
                ...
                <button @click="btn__iniciar_sesion">Iniciar Sesión</button>
            </div>
            <div class="caja_trasera-register">
                <h3>¿Aún no tienes cuenta?</h3>
                <p>Registrate para que puedas iniciar sesión</p>
                <button @click="$router.push('regisPa')">Registrarse</button>
                <!--<button @click="$router.push('Registro')">Registrarse</button>-->
            </div>
        </div>
        ...
        <div class="contenedor__ini-reg">
            ...
            <form action="" class="formulario__inicio">
                ...
                <button @click="$router.push('PagUser')">Entrar</button>
            </form>
            <form action="" class="formulario_reg">
                <!--Registro-->
                <h2>Registrarse</h2>
                <input type="text" placeholder="ID" minlength="8" maxlength="8">
                <input type="text" placeholder="Nombre">
                <input type="text" placeholder="Apellido">
                <p>Fecha de nacimiento</p>
                <input type="date" id="start" name="trip-start">
                <input type="text" placeholder="Edad">
                <input type="text" placeholder="RH">
                <input type="text" placeholder="Correo Electronico">
                <input type="text" placeholder="Celular" minlength="10" maxlength="10">
                <input type="text" placeholder="Direccion">
                <input type="text" placeholder="Ciudad">
                <input type="text" placeholder="Familiar Responsable">
                <input type="text" placeholder="Parentesco">
                <input type="text" placeholder="Correo Responsable">
                <input type="text" placeholder="Celular Responsable" minlength="10" maxlength="10">
...
processLoginPacienteUser: function(){
axios.post(
...
.then((result) => {
let dataLoginPaciente = {
username: this.user.username,
token_access: result.data.access,
token_refresh: result.data.refresh,
}

this.$emit('completedLoginPaciente', dataLoginPaciente)
